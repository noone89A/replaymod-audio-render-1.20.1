...
public final class AudioRender {
    ...
    public synchronized void submit() {
        ...
        var soundEngine = (MixinSoundEngineAccessor) soundManager.getSoundSystem();
        var library = (MixinLibraryAccessor) soundEngine.getSoundEngine();

        long devicePointer = library.getDevicePointer();
        ...
        ((SoundSystem) soundEngine).updateListenerPosition(camera);
